...
# ╔═╡ ea0521aa-1948-11ed-2ea3-2d4770d64acb
begin
	using NCDatasets
	using Navigation
	using Plots
...
# ╔═╡ 6c0b7013-1a80-4b6e-a628-eb0aecdca782
TT = LLAfromUTM(0,true, wgs84)

# ╔═╡ 8b258228-85aa-4304-bb5c-04fe89099527
UTM(-2353926.81,-382558.89) |> TT

# ╔═╡ 3ee14dbc-9691-4b1c-b7b0-d56673ecb087
EE = LLAfromECEF(wgs84)

# ╔═╡ f300a0a1-f571-48bc-a18d-5ff8a51b9f0e
# reading a SAR file
begin
	sar_file = joinpath(homedir(), "LIM/data/SeaIce/luisa_leadfraction/pairs_20200414T07261586_20200415T08071586_deformation_moved.nc")
	sar = NCDataset(sar_file, "r");
end;
...
[[deps.GMT]]
deps = ["Conda", "Dates", "Pkg", "PrettyTables", "Printf", "Statistics", "Tables"]
git-tree-sha1 = "868aeda4573d8b35daf605d2e98f729f267a227f"
...
git-tree-sha1 = "3d81cbe30a384061854c96fac12f02f5e7e372d3"
